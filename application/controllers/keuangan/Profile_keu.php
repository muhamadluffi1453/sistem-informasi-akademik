...
class Profile_keu extends CI_Controller{
	public function index()
	{
		...
		$this->load->view('profile_keu/data_profile', $data);
	...
	public function edit()
	{
		...
		$this->load->view('templates_admin/templates_keu/auth_header', $data);
		$this->load->view('templates_admin/templates_keu/sidebar');
		$this->load->view('templates_admin/templates_keu/topbar');
		$this->load->view('profile_keu/edit_data', $data);
		$this->load->view('templates_admin/templates_keu/auth_footer');
		} else {
		...
		redirect('keuangan/profile_keu/index');
		}
