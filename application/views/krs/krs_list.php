...
?>
	...
	<?php
	 if ($nilaiSmstrKmrn<=2.00 && $jumlahSks<13) {
	 	echo "<a href='".base_url()."tatausaha/krs/tambah_krs/".$nim."/".$id_thn_akad."'><button class='btn btn-sm btn-primary mb-3'><i class='fas fa-plus fa-sm'></i>Tambah Data KRS</button></a> ";
